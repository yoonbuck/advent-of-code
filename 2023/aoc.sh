...
cmd_run() {
  ...
  if [ -z "$AOC_RUN_INPUT" ]; then
    export AOC_RUN_INPUT="input/full.txt"
  fi
...
cmd_test() {
  ...
  if [ -z "$AOC_TEST_INPUT" ]; then
    export AOC_TEST_INPUT="input/test.txt"
  fi
...
cmd_show_day() {
  require_argument "day" $1
  open "https://adventofcode.com/2023/day/$1"
}
cmd_show_input() {
  require_argument "input" $1
  open "https://adventofcode.com/2023/day/$1/input"
}
